...
function MetricIndicatorRef(props) {
    ...
    return SelectEntry({
        ...
        getOptions() {
            return searchForParentIndicators(element, []).map(indicatorElement => {
...
function searchForParentIndicators(element, indicatorElements) {
    const indicatorElementsTmp = indicatorElements;
    ...
    if (businessObject.$parent) {
        return searchForParentIndicators(businessObject.$parent, indicatorElementsTmp)
    } else {
