...
import {createElement, getExtensionElementsList} from "../helpers/extensions-helper";
...
function SustainableDevelopmentIndicatorRefProperty(props) {
    ...
    const sustainableDevelopmentGoalDefinition = getExtensionElementsList(processElement, 'sustainability:SustainableDevelopmentGoal')
